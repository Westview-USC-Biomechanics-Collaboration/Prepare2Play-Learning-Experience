...
def find_contact_top(locationin, forcedata):
    ...
    Fx1 = float(forcedata.iloc[1]) * force_pixel_ratio + a1_coords
    Fy1 = float(forcedata.iloc[2]) * force_pixel_ratio + b1_coords

    Fx2 = float(forcedata.iloc[10]) * force_pixel_ratio + a2_coords
    Fy2 = float(forcedata.iloc[11]) * force_pixel_ratio + b2_coords
    ...
    contactpoint1 = find_deltaxy(angle_to_use_1, HYPOTENUSE1) + force_plate["plate1"]
    contactpoint2 = find_deltaxy(angle_to_use_2, HYPOTENUSE2) + force_plate["plate2"]

    print(contactpoint1)
    print(contactpoint2)

    # find force end point
    endpoint1 = find_deltaxy(vector1_angle, HYPOTENUSE3) + force_plate["plate1"]
