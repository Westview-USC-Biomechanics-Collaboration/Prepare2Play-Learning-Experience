...
def uploadVideoCallback(self):
    def _upload_video_with_view(selected_view, video_path):
    ...
    def on_confirm():
        ...
        # --- Safe file dialog in a fast folder ---
        initial_folder = r"C:\Users\nishk\Downloads"  # adjust to your folder
        ...
        _upload_video_with_view(selected_view, video_path)
