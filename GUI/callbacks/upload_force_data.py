...
def uploadForceDataCallback(self):
    # --- Safe file dialog in fast folder ---
    initial_folder = r"C:\Users\nishk\Downloads"  # adjust folder
...
def process(self, file_path):
    ...
    forceTimeline = Image.fromarray(self.timelineManager.timeline1.draw_rect(self.state.loc))

    canvas_width = self.timelineManager.force_canvas.winfo_width()
    canvas_height = self.timelineManager.force_canvas.winfo_height()
