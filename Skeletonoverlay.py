...
# Example usage:
video_path = 'outputs/gis_lr_CC_top_vid03_vector_overlay.mp4'  # Replace with your input video file path
filename = "outputs/gis_lr_CC_top_vid03_vector_overlay_COM.mp4"
